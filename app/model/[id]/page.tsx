...
Connections:  {
  ...
  const model = {
    ...
    artistVerified: apiModel.creator?.is_verified_creator || false,
    price: apiModel.price || 0,
    platformFee: (apiModel.price || 0) * 0.075, // 7.5%
    description: apiModel.description || "No description available",
    polyCount: apiModel.poly_count || 0,
    triangles: apiModel.poly_count || 0,
            ...
            <div className="sticky top-0 z-20 bg-slate-900/95 backdrop-blur-xl">
              ...
              <div className="flex border-b border-orange-500/20">
                <button
                  ...
                  className={`flex-1 px-3 py-3 text-xs font-semibold transition ${mobileTab === 'controls'
                ...
                <button
                  ...
                  className={`flex-1 px-3 py-3 text-xs font-semibold transition ${mobileTab === 'specs'
                      ? 'text-orange-400 border-b-2 border-orange-500'
                      : 'text-gray-400'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 px-3 py-3 text-xs font-semibold transition ${mobileTab === 'ide'
                      ? 'text-orange-400 border-b-2 border-orange-500'
                      : 'text-gray-400'
                    }`}
                >
            ...
            <div className="sticky top-0 z-20 bg-slate-900/95 backdrop-blur-xl border-b border-orange-500/20">
              <div className="flex">
                <button
                  ...
                  className={`flex-1 px-4 py-3 text-sm font-semibold transition ${activeTab === 'specs'
                      ? 'text-orange-400 border-b-2 border-orange-500'
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-3 text-sm font-semibold transition ${activeTab === 'ide'
                      ? 'text-orange-400 border-b-2 border-orange-500'
                      : 'text-gray-400 hover:text-orange-300'
                    }`}
                >
