...
export default function LearningCenterManagementPage() {
  ...
  const handleTogglePublish = async (id: number) => {
    // TODO: Implement toggle publish API endpoint
    console.log("Toggle publish for course:", id);
  };
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    ...
                    <span className={`px-3 py-1 rounded-full font-semibold ${tutorial.published
