...
export default function InventoryPage() {
  ...
  const { models: apiModels, loading, error, refetch } = useInventory({
    limit: 50,
    sort: sortBy === 'recent' ? 'newest' : 'newest' as const,
  });
          ...
          <div className="flex gap-2 sm:gap-4 w-full sm:w-auto">
            ...
            <div className="flex gap-1 sm:gap-2 p-1 bg-slate-900/50 border border-orange-500/30 rounded-lg flex-1 sm:flex-none">
              <button
                ...
                className={`flex-1 sm:flex-none px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition ${viewMode === "table"
              ...
              <button
                ...
                className={`flex-1 sm:flex-none px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition ${viewMode === "grid"
                    ? "bg-orange-500/20 text-orange-400"
                    : "text-slate-400 hover:text-white"
                  }`}
              >
